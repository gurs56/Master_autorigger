...
def main():
    ...
    switches = {
        "l_Leg_SWITCH": {
            ...
            "ik_items": ["controls_IK_Leg_1_L", "JNT_IK_thigh_l"],
            "fk_items": ["controls_FK_Leg_1_L", "JNT_FK_thigh_l"]
        },
        "r_Leg_SWITCH": {
            "joint_list": leg_list_r + foot_list_r,
            "ik_items": ["controls_IK_Leg_1_R", "JNT_IK_thigh_r"],
            "fk_items": ["controls_FK_Leg_1_R", "JNT_FK_thigh_r"]
        }
    }
