...
def main():
    ...
    for side in sides:
        # fk arm setup
        joints = [
                i for i in process.get_option( 'FK arms' , 
        ...
        # rename cnts
        rename = ['upperarm', 'lowerarm', 'hand']
        cnt_index = 0
        for cnt in arm.controls[:]:
        ...
        hide_items = ['controls_fk_Arm_1_%s' % side.upper()]
