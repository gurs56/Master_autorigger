...
def main():
    ...
    for side in sides:
        ...
        cmds.setAttr('CNT_IK_LEG_BTM_1_%s.autoTwist'%side.upper(), .5 )
        ...
        hide_items = ['controls_ik_Leg_1_%s' % side.upper(), 'xform_CNT_IK_LEG_BTM_1_%s' % side.upper()]
